...
class BaseModel(object):
    ...
    def _add_train_op(self, method, loss, learning_rate, clip='global'):
    ...
    def _initialize_session(self):
        self.logger.info("Initialzie TF session")
    ...
    def _save_model(self):
        self.saver.save(
            self.sess, self.configs.checkpoint_prefix, self.global_step + 1
        )
